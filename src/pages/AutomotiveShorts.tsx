...
const steps = [
  ...
  },
  {
    icon: Camera,
    title: "De shootdag",
    text: "Door de scripts weten we precies wat er moet gebeuren en schieten we alles in korte tijd. Willen jullie niet voor de camera staan is dat geen probleem.",
  },
  {
    icon: Clapperboard,
